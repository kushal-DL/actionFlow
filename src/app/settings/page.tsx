...
import { Sun, Calendar, GanttChartSquare, Users, Settings as SettingsIcon, AlertTriangle, ArrowLeft, Eye } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const { showProgress, showFilters, toggleShowProgress, toggleShowFilters } = useUIStore();
                    ...
                    <Card className="max-w-xl mx-auto">
                        <CardHeader>
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-xl font-semibold">View Preferences</h2>
                            </div>
                        </CardHeader>
                        <CardContent className="space-y-6 pt-6">
                            <div className="flex flex-col sm:flex-row items-center justify-between p-4 border rounded-lg">
                                <div>
                                    <h3 className="font-semibold">Show Progress Bar</h3>
                                    <p className="text-sm text-muted-foreground">Display the completion progress bar at the top of each checklist.</p>
                                </div>
                                <Switch
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-between p-4 border rounded-lg">
                                <div>
                                    <h3 className="font-semibold">Show Task Filters</h3>
                                    <p className="text-sm text-muted-foreground">Display controls to filter tasks by owner or hide completed tasks.</p>
                                </div>
                                <Switch
                                    checked={showFilters}
                                    onCheckedChange={toggleShowFilters}
                                    aria-label="Toggle task filter visibility"
                                />
                            </div>
                        </CardContent>
                    </Card>
