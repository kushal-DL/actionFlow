 ...
 * - TaskAssistantOutput - The return type for the taskAssistantRouter function.
 */
...
export async function taskAssistantRouter(
  ...
  const prompt = `You are "Jarvis," a master intent-detection AI for the ActionFlow app.
...
1.  **'create_tasks'**: The user wants to create one or more tasks. This is for any command or statement that implies a new to-do item.
    - Look for imperative verbs like "add", "create", "remind me to", "schedule", "make a task", "we need to".
...
2.  **'answer_question'**: The user is asking a question about their existing tasks or asking for general knowledge.
    - Look for interrogative words like "what", "who", "when", "show me", "do I have".
    - Examples: "what do I have to do today?", "who is working on the report?", "what is the capital of France?".
